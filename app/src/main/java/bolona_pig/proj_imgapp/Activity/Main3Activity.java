        ...
        if (id == R.id.action_search) {
            ...
            dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!isSexSelected) {
                        Toast.makeText(Main3Activity.this, "กรุณาเลือกเพศ", Toast.LENGTH_SHORT).show();
                    } else if (sex.equals(getResources().getString(R.string.sexBoth)) && minValue == 0 && maxValue == 0) {
                        Toast.makeText(Main3Activity.this, "กรุณาเลือกช่วงอายุ", Toast.LENGTH_SHORT).show();
                    } else if (maxValue < minValue) {
                        Toast.makeText(Main3Activity.this, "ช่วงอายุไม่ถูกต้อง", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(Main3Activity.this, "[" + sex + "," + minValue + "," + maxValue + "]", Toast.LENGTH_SHORT).show();
                        serverRequest.customSearchInBG(sex, minValue, maxValue, new GetItemCallback() {
                            ...
                            public void done(ArrayList<GridItem> item, String resultStr) {
                                if (item.size() > 0) {
                                    ...
                                    midModule.showAlertDialog(resultStr, Main3Activity.this);
                                }
                                minValue = 0;
                                maxValue = 0;
                            }
